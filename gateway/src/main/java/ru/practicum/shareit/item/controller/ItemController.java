...
public class ItemController {
    ...
    @GetMapping
    public ResponseEntity<Object> getUsersItems(@RequestHeader(HEADER) long userId,
    ...
    @GetMapping("/search")
    public ResponseEntity<Object> getSearchedItem(@RequestHeader(HEADER) long userId,
